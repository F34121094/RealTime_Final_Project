...
# ==========================================
FILE_GENERATE = "src/task_generator.py"              # ⚠️ 補上 src/，且檔名是 generator
FILE_GENERATE_2 = "src/task_generate_unexpected.py"  # ⚠️ 補上 src/
FILE_LEVEL1 = "src/scheduler.py"                # ⚠️ 補上 src/
FILE_LEVEL2 = "src/scheduler_v2_0.py"                # ⚠️ 補上 src/
FILE_EVALUATE = "src/evaluator.py"                   # ⚠️ 補上 src/

FILE_READ = "output/evaluation_results.json"         # ⚠️ 補上 output/
OUTPUT_CSV = "output/benchmark_results.csv"          # (選擇性) 建議一起放進 output 資料夾比較乾淨
